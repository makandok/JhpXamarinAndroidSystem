...
{
    [Activity(Label = "my activity label", Icon = "@drawable/jhpiego_logo")]
    public class SampleHomeActivity : Activity
    {
        ...
        MyClientLookupInfo getClientFromIntent(Intent data)
        {
            var clientString = data.GetStringExtra(Constants.BUNDLE_SELECTEDCLIENT);
            return Newtonsoft.Json.JsonConvert
                .DeserializeObject<MyClientLookupInfo>(clientString);
        }
        ...
        void showPPXHome()
        {
            ...
            //todo: add logic that finds a button and fires each for your main activities
